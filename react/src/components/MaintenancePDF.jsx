    ...
    return (
      <div ref={ref} className="printable-container">
        ...
        {props.data.map((item, index) => (
          <div key={item.id}  className={`print-page ${index > 0 ? "page-break" : ""}`} >
            ...
            <header className="report-header ">
              ...
              <div className="report-header flex justify-between items-center print-flex mb-1">
                ...
                <img
                  src={cintillo}
                  alt="cintillo"
                  className="w-64 mt-2 h-max print-img-large"
                />
                <img
                  src={logo}
                  alt="logo"
                  className="w-6 h-auto print-img-small"
                />
              </div>
              ...
              <div className="info-grid">
                ...
                <div className=" border-b my-2 w-full relative justify-center items-center py-4 flex -">
                  ...
                  <div className="col-auto w-full">
                    ...
                    <div className=" flex px-1">
                      ...
                      <p className="">
                        <span className="text-bold">Servicio:</span> {item.area}
                      </p>
                    </div>
                  </div>
                </div>
                <div className="info-grid-2 flex container_flex_item border-b justify-between">
                  ...
                  <div className=" border-r ">
                    ...
                    <p className="px-1"> {item.product_name}</p>
                  </div>
                  <div className="border-r">
                    ...
                    <p className="px-1"> {item.product_brand}</p>
                  </div>
                  <div className="border-r">
                    ...
                    <p className="px-1"> {item.product_model}</p>
                  </div>
                  <div className="border-r">
                    ...
                    <p className="px-1"> {item.serial_number}</p>
                  </div>
                  <div>
                    ...
                    <p className="px-1"> {item.national_code}</p>
                  </div>
                </div>
                <div className="flex border-b px-1 gap-3">
                  
                  <p className=" text-bold "> Tipo de mantenimiento: </p>
                  <p> {item.type_maintenance_name}</p>
                </div>
                <div className="flex border-b px-1 gap-3">
                  
                  <p className=" text-bold "> Status: </p>
                  <p> {item.machine_status_name}</p>
                </div>
                <div>
                  ...
                  <p className="px-1 border-b"> {item.description}</p>
                </div>
                <div className="flex ">
                  
                  <div className="w50 border-r px-1 pb-7">
                    
                    <p className="text-bold "> Elaborado por: </p>
